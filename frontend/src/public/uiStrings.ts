...
const STRINGS = {
  ...
  'catalog.loadError': {
    ru: 'Не удалось загрузить каталог. Попробуйте обновить страницу или свяжитесь с нами напрямую.',
    en: 'Failed to load the catalog. Try refreshing the page or contact us directly.',
    tg: 'Каталог бор нашуд. Саҳифаро нав кунед ё бевосита бо мо тамос гиред.',
    fa: 'بارگذاری کاتالوگ ناموفق بود. صفحه را دوباره بارگذاری کنید یا مستقیماً با ما تماس بگیرید.',
  },
  'catalog.unavailable': {
